        ...
        <div class="span9">
          ...
          <div class="row-fluid">
            <div class="span4">
              ...
              <p>1.Download and install the AndroidOS application.</p>
              <p>2.Create a new username/password in the User Management section</p>
              <p>3.Enter your credentials in the mobile application.</p>
              <p>More to come...</p>
            </div><!--/span-->
