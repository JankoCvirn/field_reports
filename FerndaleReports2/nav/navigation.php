<div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="nav-header">Reports Manager</li>
              <li ><a href="../lrmmain.php">Labor&Material Field Report</a></li>
              <li class="nav-header">Reports Publisher</li>
              <li ><a href="../report_publisher/lrm_publisher.php">Labor&Material Field Report</a></li>
